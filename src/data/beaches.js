export const beachesData = [
  {
    ...
    region: "Lampedusa, Sicily",
    description: "Consistently voted among the world's top five beaches — powdery white sand, nesting sea turtles and water so clear it looks Mediterranean digitally enhanced. No motor access.",
  ...
  },
  {
    id: 2,
    name: "Cala Mariolu",
    region: "Baunei, Sardinia",
    description: "A legendary Sardinian cove with ivory-white pebbles and water in twelve shades of blue. Reachable only by boat or a 2-hour hike. The water is the clearest in the Mediterranean.",
  ...
  },
  {
    id: 3,
    name: "Positano Beach",
    region: "Positano, Amalfi Coast",
    description: "The most photographed beach in Italy — not the biggest or sandiest, but the most dramatic setting on earth. Black pebbles, cascading pastel houses and a beach club scene that defines Amalfi glamour.",
  ...
  },
  {
    ...
    description: "Palermo's beach resort — 3km of fine white sand with clear water and Liberty-era bathing establishments. Busy with Palermitani on summer weekends; join the locals rather than avoid it.",
  ...
  },
  {
    ...
    region: "Venice Lido, Venice",
    description: "The Belle Époque island playground of Venice — grand Art Deco bathing establishments, a Film Festival, tree-lined boulevards and a long sandy beach. A world away from the canals.",
  ...
  },
  {
    ...
    description: "A perfect arc of white sand at the base of the Monte Monaco headland. Voted Italy's best beach multiple years running — clear water, fine sand and a charming Arab-Norman town behind.",
  ...
  },
  {
    ...
    description: "Italy's most famous beach resort — 15km of sand with 1,000 numbered beach clubs (stabilimenti). Loved by Italians for family holidays. Federico Fellini's hometown and muse.",
  ...
  },
  {
    id: 8,
    name: "Tropea",
    region: "Vibo Valentia, Calabria",
    description: "A medieval clifftop town with a beach of fine white sand and water that genuinely resembles the Caribbean. Often called Italy's most beautiful beach. Surprisingly unknown outside Italy.",
